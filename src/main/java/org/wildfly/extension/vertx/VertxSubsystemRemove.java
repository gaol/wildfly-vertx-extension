 ...
 */
class VertxSubsystemRemove extends AbstractRemoveStepHandler {

    static final VertxSubsystemRemove INSTANCE = new VertxSubsystemRemove();


    private VertxSubsystemRemove() {
    }
