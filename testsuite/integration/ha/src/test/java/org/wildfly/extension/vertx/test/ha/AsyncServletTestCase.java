...
/**
 * Test vertx eventbus message in async servlet on full-ha set up.
 *
...
public class AsyncServletTestCase {
    ...
    public static WebArchive createDeployment() {
        final WebArchive war = ShrinkWrap.create(WebArchive.class, "async-servlet-full-ha.war");
    ...
    public void testEchoAsyncServlet() throws Exception {
        String message = "Hi from Vertx Extension from full-ha setup";
