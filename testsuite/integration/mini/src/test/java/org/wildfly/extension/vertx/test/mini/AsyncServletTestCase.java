 ...
 */
package org.wildfly.extension.vertx.test.mini;
...
/**
 * Test vertx eventbus message in async servlet on mini set up.
 *
...
public class AsyncServletTestCase {
    ...
    public static WebArchive createDeployment() {
        final WebArchive war = ShrinkWrap.create(WebArchive.class, "async-servlet-mini.war");
    ...
    public void testEchoAsyncServlet() throws Exception {
        String message = "Hi from Vertx Extension from mini setup";
